...
# Similarly for developer
developer_text = gameinfo.find("a", href=re.compile("developer"))
if developer_text:
    developer = list(developer_text.stripped_strings)[0]
else:
    developer = "N/A"
    
# Similarly for publisher
publisher_text = gameinfo.find("a", href=re.compile("publisher"))
if publisher_text:
    publisher = list(publisher_text.stripped_strings)[0]
else:
    publisher = "N/A"
...
if review:
    print
    print "[URL=" + review + "][b]IGN Review[/b][/URL]"
print "[/quote]"
print
